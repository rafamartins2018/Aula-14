...
BITCOIN <- read_excel("C:/EconometriaA/Bitcoin.xls")

Bitcoin <- ts <- ts(BITCOIN$Close, start = 2016, frequency = 365)
...
plot(Bitcoin)
lines(ts(fitted(fm0), start = 2016, freq=365), col = 3)
lines(ts(fitted(fm1), start = 2016, frequency=365), col = 4)
lines(ts(fitted(fm2), start = 2016, frequency=365), col = 1)
lines(bp_ts)
